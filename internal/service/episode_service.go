...
func (s *EpisodeService) Delete(id, ownerID uint64) error {
	...
	if err := s.chapterRepo.DeleteByEpisode(id); err != nil {
		return appErr.Wrap(err, 500, "delete chapters")
	}
	if err := s.episodeRepo.Delete(id); err != nil {
		return appErr.Wrap(err, 500, "delete episode")
	}
	return nil
}
